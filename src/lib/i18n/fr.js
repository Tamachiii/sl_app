const fr = {
  ...
  coach: {
    ...
    sheet: {
      ...
      phaseMenu: 'Options de la phase',
      phaseNamePlaceholder: 'Nommer cette phase',
      unnamedPhase: 'Phase sans nom',
      addPhase: '+ PHASE',
      reorderPhases: 'Réorganiser les phases',
      reorderPhase: 'Réorganiser {name}',
      reorderSessionsHint: 'Dépose une séance sur un nom de phase pour l’y déplacer.',
      deletePhase: 'supprimer la phase',
      deletePhaseTitle: 'Supprimer la phase',
      deletePhaseMessage: 'Supprimer cette phase ? Ses séances seront supprimées avec elle.',
      deletePhaseNamed: 'Supprimer « {name} » ? Ses séances seront supprimées avec elle.',
      copyPhaseTitle: 'Copier la phase vers un autre athlète',
    },
    week: {
