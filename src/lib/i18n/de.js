  ...
  coach: {
    ...
    dashboard: {
      ...
      dayStatus: {
        performed: 'Trainiert',
        today: 'Heute',
        planned: 'Empfohlenes Datum',
        suggested: 'Empfohlener Tag',
        archived: 'Entfernt',
        rest: 'Ruhetag',
      },
    },
    ...
    sheet: {
      ...
      unarchiveSession: 'Diese Einheit wiederherstellen',
      copySessionsTitle: 'Einheiten kopieren',
      copySessionsDescription: 'Kopiert {n} Einheit(en) ans Ende der Zielwoche. Vorgaben werden übernommen, die protokollierten Sätze des Athleten nicht.',
      reorderSession: '{name} neu anordnen',
      duplicateSession: 'Einheit duplizieren',
      phaseMenu: 'Phasen-Optionen',
      phaseNamePlaceholder: 'Phase benennen',
      unnamedPhase: 'Unbenannte Phase',
      addPhase: '+ PHASE',
      reorderPhases: 'Phasen neu anordnen',
      reorderPhase: '{name} neu anordnen',
      reorderSessionsHint: 'Ziehe eine Einheit auf einen Phasennamen, um sie dorthin zu verschieben.',
      deletePhase: 'Phase löschen',
      deletePhaseTitle: 'Phase löschen',
      deletePhaseMessage: 'Diese Phase löschen? Ihre Einheiten werden mit entfernt.',
      deletePhaseNamed: '„{name}“ löschen? Ihre Einheiten werden mit entfernt.',
      copyPhaseTitle: 'Phase zu anderem Athleten kopieren',
    },
    week: {
    ...
    copy: {
      ...
      destinationBlock: 'Zielblock',
      selectBlock: 'Block wählen',
      selectBlockFirst: 'Wähle zuerst einen Block',
      noBlocks: 'Dieser Athlet hat noch keinen Block',
      activeSuffix: ' (aktiv)',
