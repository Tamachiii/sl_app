const en = {
  ...
  coach: {
    ...
    week: {
      ...
      delete: 'delete',
      noActiveSessions: 'No active sessions — {n} archived. Use "Show {n} archived" below.',
      noSessions: 'No sessions yet',
      sessionN: 'Session {n}',
      editSessionTitleAria: 'Edit session title',
      exCount: '{n} ex',
      ...
      copyTitle: 'Copy week to another student',
      ...
      deleteWeekMessage: 'Delete Week {n}? This will remove all its sessions.',
